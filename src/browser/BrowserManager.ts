...
class BrowserManager {
     ...
     */
    async getPlainProperty(element: puppeteer.ElementHandle<Element>, property: string) : Promise<any> {
        const _property = await element.getProperty(property).then(x => x.jsonValue())
